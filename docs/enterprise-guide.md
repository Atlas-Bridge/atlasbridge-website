...
6. **Evaluate counterfactuals** *(roadmap)*: Use replay to evaluate whether different policy configurations would have produced different outcomes.
...
| Ticketing (Jira, ServiceNow) | Escalation events forwarded via webhook *(roadmap)* |
