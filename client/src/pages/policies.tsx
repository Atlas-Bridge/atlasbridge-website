        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button
                className="bg-[#1F8A8C] hover:bg-[#1a7577] text-white w-full sm:w-auto"
            ...
            <DialogContent className="sm:max-w-lg mx-4 sm:mx-auto">
              ...
              >
                <div className="space-y-2">
                  <Label htmlFor="name" className="text-[#0B2A3C] font-semibold">
                    Policy Name
                  </Label>
                  <Input
                    id="name"
                ...
                <div className="space-y-2">
                  <Label htmlFor="desc" className="text-[#0B2A3C] font-semibold">
                    Description
                  </Label>
                  <Textarea
                    id="desc"
                ...
                <div className="space-y-2">
                  ...
                  <Select value={enforcement} onValueChange={setEnforcement}>
                    <SelectTrigger
                      ...
                      data-testid="select-enforcement"
                    >
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <Button
                  type="submit"
                  className="w-full bg-[#0B2A3C] hover:bg-[#071D2B] text-white"
