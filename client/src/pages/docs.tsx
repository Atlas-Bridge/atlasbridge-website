        ...
        <main className="flex-1 min-w-0 px-4 sm:px-8 lg:px-16 py-10 sm:py-14">
          {isLoading ? (
            ...
            <article className="docs-article max-w-3xl">
              <ReactMarkdown
                ...
                components={{
                  ...
                  h3: ({ children, ...props }) => (
                    <h3
                      className="text-lg sm:text-xl font-bold text-[#0B2A3C] mt-10 mb-4"
                      {...props}
                    >
                      {children}
                    </h3>
                  ...
                  li: ({ children, node, ...props }) => {
                    ...
                    if (parent === "ol" || (props as any).index !== undefined) {
                      return (
                        <li
                          className="text-[15px] sm:text-base text-[#0B2A3C]/80 leading-[1.8] pl-1.5"
                          {...props}
                        >
                          {children}
                        </li>
                  ...
                  code: ({ className, children, ...props }) => {
                    ...
                    return (
                      <code
                        className="bg-[#0B2A3C]/[0.06] text-[#0B2A3C] px-1.5 py-0.5 rounded text-[13px] font-mono font-medium"
                        {...props}
                      >
                        {children}
                      </code>
                  ...
                  thead: ({ children, ...props }) => (
                    <thead className="bg-[#F5F7F9]" {...props}>
                      {children}
                    </thead>
                  ),
                  th: ({ children, ...props }) => (
                    <th
                      className="px-4 sm:px-5 py-3.5 text-left text-xs font-bold text-[#0B2A3C] uppercase tracking-wider"
                      {...props}
                    >
                      {children}
                    </th>
                  ...
                  td: ({ children, ...props }) => (
                    <td
                      className="px-4 sm:px-5 py-3.5 text-sm text-[#0B2A3C]/80 border-t border-gray-100 align-top"
                      {...props}
                    >
                      {children}
                    </td>
                  ...
                  em: ({ children, ...props }) => (
                    <em className="text-[#0B2A3C]/70" {...props}>
                      {children}
                    </em>
                  ),
                }}
            ...
            <div className="text-center py-20">
              ...
              <Link href="/docs">
                <Button
                  className="bg-[#1F8A8C] hover:bg-[#1a7577] text-white mt-4"
                  data-testid="link-back-docs"
                >
                  Back to Documentation
                </Button>
          ...
          {doc && (
            <div className="mt-16 pt-8 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 max-w-3xl">
              {DOC_ORDER.indexOf(slug) > 0 ? (
                <Link
                  href={
                    DOC_ORDER[DOC_ORDER.indexOf(slug) - 1] === "index"
                      ? "/docs"
                      : `/docs/${DOC_ORDER[DOC_ORDER.indexOf(slug) - 1]}`
                  }
                >
                  <Button
                    variant="ghost"
