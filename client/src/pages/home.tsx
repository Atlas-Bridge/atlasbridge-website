...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#F5F7F9] text-[#0B2A3C] font-sans selection:bg-[#1F8A8C]/30">
      ...
      <main>
        {/* Hero Section */}
        <section id="overview" className="relative overflow-hidden bg-[#071D2B] py-24 lg:py-32">
          ...
          <div className="container relative mx-auto px-4 lg:px-8">
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              <div className="max-w-2xl">
                ...
                <p className="mt-6 text-lg text-[#6E7A86] sm:text-xl">
              ...
              <div className="relative">
                <div className="relative z-10 grid gap-4">
                  {/* Mock Terminal Card */}
                  <Card className="border-0 bg-[#0B2A3C] shadow-2xl overflow-hidden font-mono text-sm">
                    <div className="flex items-center gap-2 border-b border-white/5 bg-white/5 px-4 py-2">
                      ...
                      <span className="text-xs text-white/40">atlasbridge — supervisor</span>
                    </div>
                    <CardContent className="p-4 text-[#6E7A86]">
                      <div className="flex items-start gap-3">
                        <span className="text-green-400">➜</span>
                        <div className="space-y-1">
                          <p className="text-white">atlasbridge run claude --policy strict</p>
                          ...
                          <p className="text-yellow-400 mt-2">! Human Escalation Required: File modification 'config.json'</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-sm font-semibold text-white flex items-center gap-2">
                          <ShieldCheck className="h-4 w-4 text-[#1F8A8C]" />
                          Policy Decision Trace
                        </h3>
                        <Badge className="bg-[#1F8A8C]/20 text-[#1F8A8C] border-0">DETERMINISTIC</Badge>
                      </div>
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between text-xs py-2 border-b border-white/5">
                          ...
                          <span className="text-white">APPEND_ONLY_SIGNED</span>
                        </div>
            ...
            <div className="grid gap-16 lg:grid-cols-2">
              <div className="space-y-8">
                <div className="space-y-4">
                  <h2 className="text-3xl font-bold tracking-tight">What it is</h2>
                  <div className="grid gap-4">
                    {[
                      ...
                      <div key={i} className="flex items-center gap-3 p-4 rounded-lg bg-[#F5F7F9]">
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  <h2 className="text-3xl font-bold tracking-tight opacity-50">What it is not</h2>
                  <div className="grid gap-4">
                    {[
        ...
        {/* How It Works */}
        <section id="how-it-works" className="py-24 bg-[#F5F7F9]">
          <div className="container mx-auto px-4 lg:px-8">
              ...
              {[
                ...
                <Card key={i} className="border-0 shadow-sm relative overflow-hidden group">
                  <CardContent className="p-8">
                    ...
                    <p className="text-[#6E7A86] leading-relaxed">{step.desc}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
        ...
        {/* Security Section */}
        <section id="security" className="py-24 bg-[#0B2A3C] text-white overflow-hidden relative">
          <div className="absolute top-0 right-0 w-1/3 h-full bg-[#1F8A8C]/5 skew-x-12 transform" />
          <div className="container mx-auto px-4 lg:px-8 relative">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-6">Security & Compliance Alignment</h2>
                <div className="space-y-6">
                  {[
                    ...
                    <div key={i} className="flex gap-4 items-start">
                      ...
                      <p className="text-white/80 leading-snug">{bullet}</p>
                    </div>
                  ))}
                </div>
                <p className="mt-8 text-sm text-[#6E7A86] italic border-l-2 border-[#1F8A8C] pl-4">
          ...
          <div className="container mx-auto px-4 lg:px-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="p-6 rounded-2xl border bg-[#F5F7F9] hover:border-[#1F8A8C]/40 hover:bg-white transition-all group">
                  <feat.icon className="h-8 w-8 text-[#1F8A8C] mb-4" />
        ...
        {/* Install Section */}
        <section id="install" className="py-24 bg-[#F5F7F9]">
          <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
            <div className="bg-[#0B2A3C] rounded-3xl overflow-hidden shadow-2xl">
              <div className="p-8 lg:p-12">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="bg-black/40 rounded-xl p-4 font-mono text-sm text-[#F5F7F9] border border-white/10 flex items-center justify-between group">
                      <code>pip install atlasbridge</code>
                      <Button variant="ghost" size="sm" className="opacity-0 group-hover:opacity-100 transition-opacity text-white/40">Copy</Button>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <p className="text-xs font-semibold text-[#1F8A8C] uppercase tracking-widest">Setup</p>
                    <div className="bg-black/40 rounded-xl p-4 font-mono text-sm text-[#F5F7F9] border border-white/10">
                      <code>atlasbridge setup --channel telegram</code>
                    </div>
                  </div>
                  <div className="space-y-2">
                ...
                <div className="mt-8 p-4 rounded-xl bg-yellow-500/10 border border-yellow-500/20 flex gap-3 items-start">
        ...
        <section id="roadmap" className="py-24 bg-white">
          <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
            <h2 className="text-3xl font-bold text-center mb-16">Roadmap Preview</h2>
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-6 rounded-2xl border hover:shadow-md transition-shadow">
                  <div className="flex items-center gap-4">
                    <span className="text-sm font-mono text-[#6E7A86]">{item.version}</span>
                    <h4 className="font-bold">{item.title}</h4>
                  </div>
                  <Badge variant="outline" className="border-[#0B2A3C] text-[#0B2A3C]">{item.status}</Badge>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-[#071D2B] text-white py-16">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4 mb-16">
            <div className="col-span-2">
              ...
              <p className="text-[#6E7A86] max-w-sm mb-6">
