...
function TerminalTyping() {
  ...
  const termLines = [
    ...
    {
      text: "! Human Escalation Required: File modification 'config.json'",
      cls: "text-yellow-400 mt-2 break-words",
    },
  ];
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F7F9] text-[#0B2A3C] font-sans selection:bg-[#1F8A8C]/30">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-[100] focus:bg-[#0B2A3C] focus:text-white focus:px-4 focus:py-2 focus:rounded-md focus:text-sm"
      ...
      >
        <div className="container mx-auto flex h-16 items-center justify-between px-4 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <Button
              variant="outline"
              className="hidden sm:flex border-[#0B2A3C] text-[#0B2A3C] hover:bg-[#0B2A3C]/5 gap-2 transition-all duration-300 hover:scale-105"
              asChild
            >
              <a href="https://github.com/Atlas-Bridge" target="_blank" rel="noopener noreferrer">
                <Github className="h-4 w-4" />
                GitHub
              </a>
            </Button>
            <Button
              className="hidden sm:flex bg-[#0B2A3C] text-white hover:bg-[#071D2B] transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-[#0B2A3C]/20"
              asChild
            >
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden border-t bg-white px-4 py-4 space-y-2">
            <Link
              ...
              className="block px-3 py-3 rounded-lg text-sm font-medium hover:bg-[#F5F7F9] transition-colors"
            >
              Docs
            </Link>
            <Link
            ...
            <div className="flex gap-2 pt-2 border-t mt-2">
              <Button
                variant="outline"
                className="flex-1 border-[#0B2A3C] text-[#0B2A3C] gap-2"
                asChild
              >
                <a href="https://github.com/Atlas-Bridge" target="_blank" rel="noopener noreferrer">
                  <Github className="h-4 w-4" />
      ...
      <main id="main-content" role="main">
        ...
        <section
          id="overview"
          className="relative overflow-hidden bg-[#071D2B] py-16 sm:py-24 lg:py-32"
        >
          ...
          <div className="container relative mx-auto px-4 lg:px-8">
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              <div className="max-w-2xl">
                ...
                >
                  AtlasBridge is a deterministic governance runtime that supervises AI CLI agents
                  with policy-driven execution, structured escalation, and audit-grade traceability.
                </p>
                <div
                ...
                >
                  <Button
                    size="lg"
                    className="bg-[#1F8A8C] text-white hover:bg-[#1F8A8C]/90 px-8 w-full sm:w-auto transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-[#1F8A8C]/30"
                    asChild
                  >
                  ...
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-white/20 text-white hover:bg-white/10 w-full sm:w-auto transition-all duration-300 hover:scale-105"
                    asChild
                  >
        ...
        <section className="py-16 sm:py-24 bg-white border-y">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="grid gap-12 lg:gap-16 lg:grid-cols-2">
              ...
              <FadeUp delay={0.15}>
                <div className="space-y-4">
                  <h2 className="text-2xl sm:text-3xl font-bold tracking-tight opacity-50">
                    What it is not
                  </h2>
                  <div className="grid gap-3 sm:gap-4">
                    {[
                      ...
                      <FadeUp key={i} delay={0.1 * (i + 1) + 0.15}>
                        <div className="flex items-center gap-3 p-3 sm:p-4 rounded-lg bg-red-50/50 border border-red-100 opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-500 card-hover-3d cursor-default">
                          ...
                          <span className="font-medium text-red-900 text-sm sm:text-base">
                            {item.text}
                          </span>
                        </div>
                      </FadeUp>
              ...
              {[
                {
                  ...
                  desc: "Create human-readable YAML policies defining what your agent can and cannot do.",
                },
                {
                  title: "Deterministic Runtime",
                  desc: "Every agent prompt and action is evaluated against your policies before execution.",
                },
                {
                  title: "Secure Execution",
                  desc: "Actions are executed locally within the AtlasBridge boundary, never in the cloud.",
                },
              ].map((step, i) => (
        ...
        <section
          id="security"
          className="py-16 sm:py-24 bg-[#0B2A3C] text-white overflow-hidden relative"
        >
                  ...
                  <div className="bg-white/5 rounded-2xl p-6 sm:p-8 backdrop-blur-sm border border-white/10 hover:border-[#1F8A8C]/30 transition-colors duration-500">
                    ...
                    <div className="space-y-4">
                      <div className="h-2 w-full bg-white/5 rounded-full overflow-hidden relative">
                        ...
                        <div
                          className="absolute inset-0 rounded-full animate-bar-shimmer"
                          style={{
                            background:
              ...
              {[
                {
                  ...
                  icon: Scale,
                  desc: "Configurable Off / Assist / Full modes for granular control.",
                },
                {
                  title: "Structured Escalation",
                  icon: UserCheck,
                  desc: "Automatic pauses and human-in-the-loop triggers.",
                },
                {
                  title: "Prompt Classification",
                  icon: FileSearch,
                  desc: "Deterministic classification of all agent intent.",
                },
                {
                  title: "Audit Integrity",
                  icon: ShieldCheck,
                  desc: "Cryptographically signed append-only logs.",
                },
                {
                  title: "Replay & Simulation",
                  icon: History,
                  desc: "Debug and verify agent actions before production deployment.",
                },
                {
                  title: "Operator Console",
                  icon: Terminal,
                  desc: "Centralized read-only visibility into all agent clusters.",
                },
              ].map((feat, i) => (
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="bg-black/40 rounded-xl p-3 sm:p-4 font-mono text-xs sm:text-sm text-[#F5F7F9] border border-white/10 flex items-center justify-between group hover:border-[#1F8A8C]/30 transition-colors duration-300">
                              ...
                              <Button
                                variant="ghost"
                                size="sm"
                                className="opacity-0 group-hover:opacity-100 transition-opacity text-white/40 hidden sm:inline-flex"
                              >
                                Copy
                              </Button>
                            </div>
                    ...
                    <FadeUp delay={0.5}>
                      <div className="mt-6 sm:mt-8 p-3 sm:p-4 rounded-xl bg-yellow-500/10 border border-yellow-500/20 flex gap-3 items-start">
                        ...
                        <p className="text-xs text-yellow-500/80 leading-snug">
                          <span className="font-bold">Security Note:</span> Never paste API tokens
                          or credentials into public logs or non-secure policy files. AtlasBridge
                          uses secure environment handling by default.
                        </p>
                      </div>
                    </FadeUp>
                  </div>
              ...
              {[
                ...
                <FadeUp key={i} delay={0.1 * i}>
                  <div className="flex items-center justify-between p-4 sm:p-6 rounded-xl sm:rounded-2xl border hover:shadow-lg transition-all duration-300 gap-3 card-hover-3d group">
                    ...
                    <Badge
                      variant="outline"
                      className="border-[#0B2A3C] text-[#0B2A3C] shrink-0 text-[10px] sm:text-xs"
                    >
                      {item.status}
                    </Badge>
                  </div>
          ...
          <div className="grid gap-10 sm:gap-12 sm:grid-cols-2 lg:grid-cols-4 mb-12 sm:mb-16">
            ...
            <div>
              ...
              <ul className="space-y-3 sm:space-y-4 text-sm text-[#94A3B3]">
                ...
                <li>
                  <Link
                    href="/docs/compliance-alignment"
                    className="hover:text-white transition-colors duration-300"
