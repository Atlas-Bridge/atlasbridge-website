      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-8 py-12 sm:py-16">
        ...
        <div className="space-y-8 text-[#0B2A3C]/80 leading-[1.85] text-[15px] sm:text-base">
          <section>
            ...
            <p>
              AtlasBridge is built with security as a core design principle. The project follows a
              local-first architecture where execution occurs within the user's own infrastructure,
          ...
          <section>
            ...
            <p>
              AtlasBridge is designed to operate entirely within your local environment. The
              governance runtime, policy engine, and audit logging all function without requiring
              connectivity to external services. Cloud connectivity, when available, is used only
              for observability and monitoring — never for execution.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              The AtlasBridge project maintains awareness of its dependency chain. We encourage
              users to review dependencies and use standard tools (such as lock files and integrity
              checks) to verify the software they install. The project source code is publicly
          ...
          <section>
            ...
            <p>
              If you discover a security vulnerability in AtlasBridge, we ask that you report it
              responsibly. Please do not disclose vulnerabilities publicly until they have been
              addressed.
            </p>
          ...
          <section>
            ...
            <p>
              Security patches and updates are distributed through standard release channels. Users
              are encouraged to keep their installations up to date and to subscribe to project
              notifications for awareness of security-related releases.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              AtlasBridge provides governance tooling to help manage AI agent behavior. It is not a
              comprehensive security solution on its own. Users should implement defense-in-depth
              strategies and assess whether AtlasBridge meets their specific security and compliance
              requirements.
            </p>
          </section>
        </div>
